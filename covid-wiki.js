...
await page.goto('https://coronavirus.data.gov.uk', {waitUntil: 'networkidle0', timeout: 60000});
await page.screenshot({path: `/home/oli/covid-tracker/covid-ukgov-${getDateString()}.png`});
await browser.close();
